			...
			switch ($this->path[0]) {
				case '':
					...
					if ($this->Wcms->loggedIn) {
						$args[0] = "<div class='text-right'><a href='#' class='button' onclick='blog.new(); return false;'><span class='glyphicon glyphicon-plus-sign'></span> Create new post</a></div>";
					}
...
HTML;
                        ...
                        <div class="text-left">
                            <br /><br />
                            <a href="../$this->slug" class="button"><span class="glyphicon glyphicon-chevron-left small"></span> Back to all blog posts</a>
                        </div>
HTML;
					} else {
